...
### 0.2 База данных
- [ ] Настроить Knex.js с TypeScript конфигурацией
- [ ] Создать базовую миграционную структуру
- [ ] Создать seed файлы для тестовых данных
- [ ] Настроить connection pooling
- [ ] Настроить GIN-индексы для полнотекстового поиска

### 0.3 Базовая архитектура
- [ ] Настроить структуру API Routes `/app/api/*`
- [ ] Интегрировать `next-swagger-doc` и `swagger-ui-react`
- [ ] Создать базовые Zod схемы для валидации
- [ ] Настроить middleware для логирования и rate-limiting
- [ ] Создать базовую систему обработки ошибок
